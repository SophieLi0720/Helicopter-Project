...
//    GPIOPadConfigSet (SW1_BUT_PORT_BASE, SW1_BUT_PIN, GPIO_STRENGTH_2MA,
//       GPIO_PIN_TYPE_STD_WPD);
//    but_normal[SW1] = DOWN_BUT_NORMAL;
...
updateButtons (void)
{
    ...
    //but_value[SW1] = (GPIOPinRead (SW1_BUT_PORT_BASE, SW1_BUT_PIN) == SW1_BUT_PIN);
